...
def main():
	...
	#try:
      ...
      try:
        ...
        p = subprocess.check_output('python '+bin+'/repeat_filter.py '+args.dir+'/contig_coverage ' + args.dir+ '/bundled_links ' +args.dir+'/invalidated_counts ' + args.dir+'/repeats ' + args.dir+'/contig_length > '+args.dir+'/bundled_links_filtered' ,shell=True)
      except subprocess.CalledProcessError as err:
        print >> sys.stderr, time.strftime("%c")+': Failed to find repeats, terminating scaffolding....\n' + str(err.output)
        sys.exit(1)

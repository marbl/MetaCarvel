...
def main():
    ...
    if os.path.exists(args.dir+'/scaffolds.fasta') == False:
      os.system('sort -k 7 -nr '+ args.dir+'/oriented_links > '+ args.dir+'/oriented_links_sorted')
      os.system('python order.py -a '+ args.assembly + ' -e ' + args.dir+'/oriented_links_sorted  -o '+args.dir+'/scaffolds.fa')
